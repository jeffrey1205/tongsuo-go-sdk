...
func TestSM4ECB(t *testing.T) {
	...
	doEncrypt(crypto.CIPHER_MODE_ECB, key, nil, plainText, cipherText, t)
...
func TestSM4CBC(t *testing.T) {
	...
	doEncrypt(crypto.CIPHER_MODE_CBC, key, iv, plainText, cipherText, t)
	doDecrypt(crypto.CIPHER_MODE_CBC, key, iv, plainText, cipherText, t)
}
...
func TestSM4OFB(t *testing.T) {
	...
	doEncrypt(crypto.CIPHER_MODE_OFB, key, iv, plainText, cipherText, t)
...
func TestSM4CTR(t *testing.T) {
	...
	doEncrypt(crypto.CIPHER_MODE_CTR, key, iv, plainText, cipherText, t)
	doDecrypt(crypto.CIPHER_MODE_CTR, key, iv, plainText, cipherText, t)
}
...
func TestSM4GCM(t *testing.T) {
	...
	doAEADEncrypt(crypto.CIPHER_MODE_GCM, key, iv, aad, tag, plainText, cipherText, t)
	doAEADDecrypt(crypto.CIPHER_MODE_GCM, key, iv, aad, tag, plainText, cipherText, t)
}
...
func TestSM4CCM(t *testing.T) {
	...
	doAEADEncrypt(crypto.CIPHER_MODE_CCM, key, iv, aad, tag, plainText, cipherText, t)
	doAEADDecrypt(crypto.CIPHER_MODE_CCM, key, iv, aad, tag, plainText, cipherText, t)
}
